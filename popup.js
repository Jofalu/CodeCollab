...
2. Implement way to use highlight.js on the text of Google Docs
3. Implement event trigger that runs highlight.js whenever the webpage saves or makes a Post Request or edits, etc.
